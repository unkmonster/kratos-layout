...
func (x *GetVersionReply) GetCommit() string {
	if x != nil {
		return x.Commit
	}
	return ""
...
func (x *GetVersionReply) GetBuildTime() string {
	if x != nil {
		return x.BuildTime
	}
	return ""
...
const file_version_v1_version_proto_rawDesc = "" +
	...
	"\x0eapi.version.v1P\x01Z4github.com/go-kratos/kratos-layout/api/version/v1;v1b\x06proto3"
...
var file_version_v1_version_proto_goTypes = []any{
	(*GetVersionRequest)(nil), // 0: api.version.v1.GetVersionRequest
	(*GetVersionReply)(nil),   // 1: api.version.v1.GetVersionReply
}
var file_version_v1_version_proto_depIdxs = []int32{
	0, // 0: api.version.v1.Version.GetVersion:input_type -> api.version.v1.GetVersionRequest
	1, // 1: api.version.v1.Version.GetVersion:output_type -> api.version.v1.GetVersionReply
