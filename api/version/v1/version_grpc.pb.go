...
const (
	Version_GetVersion_FullMethodName = "/api.version.v1.Version/GetVersion"
)
...
func (c *versionClient) GetVersion(ctx context.Context, in *GetVersionRequest, opts ...grpc.CallOption) (*GetVersionReply, error) {
...
func (UnimplementedVersionServer) GetVersion(context.Context, *GetVersionRequest) (*GetVersionReply, error) {
...
var Version_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "api.version.v1.Version",
